package com.ornettech.nmmcqcandbirthdaywishes.call;
    ...
    private CallRecord(Context context) {
        ...
        public static class Builder {
            ...
            public Builder(Context context) {
                ...
                PrefsHelper.writePrefBool(mContext, PREF_SHOW_SEED, false);
                PrefsHelper.writePrefBool(mContext, PREF_SHOW_PHONE_NUMBER, false);
            ...
            public CallRecord.Builder setRecordFileName(String recordFileName) {
            ...
            public CallRecord.Builder setRecordDirName(String recordDirName) {
            ...
            public CallRecord.Builder setAudioSource(int audioSource) {
            ...
            public CallRecord.Builder setAudioEncoder(int audioEncoder) {
            ...
            public CallRecord.Builder setOutputFormat(int outputFormat) {
            ...
            public CallRecord.Builder setShowSeed(boolean showSeed) {
            ...
            public CallRecord.Builder setShowPhoneNumber(boolean showNumber) {
            ...
            public CallRecord.Builder setRecordDirPath(String recordDirPath) {
