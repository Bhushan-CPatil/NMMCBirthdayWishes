...
public class SocietyWIseVoterDetOtherQC extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_society_wise_voter_det_other_qc);
        getSupportActionBar().setTitle(Html.fromHtml("<font color='#FFFFFF'>" + SharedPrefManager.getInstance(SocietyWIseVoterDetOtherQC.this).getElectionName() + " QC</font>"));
        ...
        sharedusername = SharedPrefManager.getInstance(SocietyWIseVoterDetOtherQC.this).username();
        sharedelectionname = SharedPrefManager.getInstance(SocietyWIseVoterDetOtherQC.this).getElectionName();
        designation = SharedPrefManager.getInstance(SocietyWIseVoterDetOtherQC.this).designation();
    ...
    private void setAdapter() {
        ...
        surveyroomlist.setLayoutManager(new LinearLayoutManager(SocietyWIseVoterDetOtherQC.this));
        surveyroomlist.setAdapter(new RecyclerView.Adapter() {
                                      @NonNull
                                      @Override
                                      public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
                                          View view = LayoutInflater.from(SocietyWIseVoterDetOtherQC.this).inflate(R.layout.adapter_room_listing, viewGroup, false);
    ...
    private void setInnerAdapter(OuterHolder myHolder, final List<VoterDetailedDataItem> voterDetailedData) {
        ...
        myHolder.innerrecyclerview.setLayoutManager(new LinearLayoutManager(SocietyWIseVoterDetOtherQC.this));
        myHolder.innerrecyclerview.setAdapter(new RecyclerView.Adapter() {
                                                  @NonNull
                                                  @Override
                                                  public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
                                                      View view = LayoutInflater.from(SocietyWIseVoterDetOtherQC.this).inflate(R.layout.adapter_survey_voter, viewGroup, false);
                                          ...
                                          SimpleDateFormat parseDate = new SimpleDateFormat("dd-MM-yyyy", Locale.US);*/
                                                      ...
                                                      innerHolder.callingbtn.setOnClickListener(new View.OnClickListener() {
                                                          ...
                                                          public void onClick(View v) {
                                                              ...
                                                              sendSMSWhatsApp.callMobNo(SocietyWIseVoterDetOtherQC.this, model.getMobileNo());
                                                              ...
                                                              Toast.makeText(SocietyWIseVoterDetOtherQC.this, "calling", Toast.LENGTH_SHORT).show();
                                                          }
                                                      });
                                                  ...
                                                  public void EditDialog(final String voterCd, String mobileNo, final int acNo, final String newBirthDate, final String tablename, final int voterid, final String voterfname, final String votermname, final String voterlname, final String remarktxt) {
                                                      final Dialog dialog = new Dialog(SocietyWIseVoterDetOtherQC.this);
                                                      ...
                                                      birthdate.setOnClickListener(new View.OnClickListener() {
                                                          ...
                                                          public void onClick(View v) {
                                                              try {
                                                                  ...
                                                                  fromDatePickerDialog = new DatePickerDialog(SocietyWIseVoterDetOtherQC.this,
                                                      ...
                                                      update.setOnClickListener(new View.OnClickListener() {
                                                          @Override
                                                          public void onClick(View v) {
                                                              AlertDialog.Builder builder = new AlertDialog.Builder(SocietyWIseVoterDetOtherQC.this);
                                    ...
                                    /*else if(m.isEmpty()){
                                        ...
                                        mname.requestFocus();
                                                  ...
                                                  public void UpdateStatusDialog(final String voterCd, String qcstatus, final int acNo, final String mobileNo) {
                                                      ...
                                                      ArrayAdapter<String> adapterx = new ArrayAdapter<String>(SocietyWIseVoterDetOtherQC.this, android.R.layout.simple_spinner_item, DBConnIP.arrayListToDialog);
    ...
    private void callApi() {
        mainlist.clear();
        final ProgressDialog progressBar = new ProgressDialog(SocietyWIseVoterDetOtherQC.this);
        progressBar.setCancelable(false);
        progressBar.setProgressStyle(ProgressDialog.STYLE_SPINNER);
        progressBar.setMessage("Please wait...");
        progressBar.show();
        Call<MainResponse> call1 = RetrofitClient
                .getInstance().getApi().getRoomWiseDetailedListOtherQC(intfrm, intto, sharedelectionname, intsite, intsubloccd, intcalling);
        call1.enqueue(new Callback<MainResponse>() {
            ...
            public void onResponse(Call<MainResponse> call1, Response<MainResponse> response) {
                ...
                if (res.getRoomWiseDetailedListPojo().size() > 0) {
                    ...
                    roomcount.setText("Total Room - " + mainlist.size());
                    Toast.makeText(SocietyWIseVoterDetOtherQC.this, "No Records Exists For Selected Criteria!", Toast.LENGTH_LONG).show();
                    surveyroomlist.getAdapter().notifyDataSetChanged();
                }
            }
            ...
            public void onFailure(Call<MainResponse> call1, Throwable t) {
                progressBar.dismiss();
                Toast.makeText(SocietyWIseVoterDetOtherQC.this, "Failed to fetch data !", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    public void updateQCResponse(final Dialog dialog, final String selspinresponse, String selvotercd, final int ac_no, final String mobileno) {
        ...
        new UploadFileToServer().execute(selvotercd, mobileno, sharedelectionname, Integer.toString(ac_no),
                intsite, SharedPrefManager.getInstance(SocietyWIseVoterDetOtherQC.this).username(), selspinresponse, filePath);
        dialog.dismiss();
    ...
    public void updateBDAndMobNo(final Dialog dialog, final String birthdate, String selvotercd, final int ac_no, final String mobileno, String tablename, final String voterfname, final String votermname, final String voterlname, final String remark) {
        ...
        progressBar1.show();
        Call<DefaultResponse> call1 = RetrofitClient
                .getInstance().getApi().updateBDAndMobileNo_uOtherQC(selvotercd, mobileno, sharedelectionname, intsite, ac_no, newBirthDate1, newBirthDate2, SharedPrefManager.getInstance(SocietyWIseVoterDetOtherQC.this).username(), tablename, voterfname, votermname, voterlname, remark);
        call1.enqueue(new Callback<DefaultResponse>() {
            @Override
            public void onResponse(Call<DefaultResponse> call1, Response<DefaultResponse> response) {
                DefaultResponse res = response.body();
    ...
    public void StartCallRecording(String filename) {
        if (checkFolder()) {
            ...
            callRecordSurvey = new CallRecord.Builder(SocietyWIseVoterDetOtherQC.this)
    ...
    private class UploadFileToServer extends AsyncTask<String, Integer, String> {
        ...
        protected void onPreExecute() {
            ...
            progressBar.show();*/
            progressBar = new ProgressDialog(SocietyWIseVoterDetOtherQC.this);
            progressBar.setCancelable(false);
            progressBar.setProgressStyle(ProgressDialog.STYLE_SPINNER);
        ...
        private String uploadFile(String votercd, String mobileno, String elecname, String acno, String intsite, String username, String callingresponse, String filePath) {
            ...
            HttpPost httppost = new HttpPost(RetrofitClient.BASE_URL + "updateCallingOtherQC_WithAudio.php");
