...
public class SocietyWIseVoterDetIConnectQC  extends AppCompatActivity {

    public TextView societyname, callingres, soccount, roomcount;
    public RecyclerView surveyroomlist;
    public String intsocname, intcalling, intsite, designation;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_society_wise_voter_det_iconnect_qc);
        getSupportActionBar().setTitle(Html.fromHtml("<font color='#FFFFFF'>" + SharedPrefManager.getInstance(SocietyWIseVoterDetIConnectQC.this).getElectionName() + " QC</font>"));
        ...
        sharedusername = SharedPrefManager.getInstance(SocietyWIseVoterDetIConnectQC.this).username();
        sharedelectionname = SharedPrefManager.getInstance(SocietyWIseVoterDetIConnectQC.this).getElectionName();
        designation = SharedPrefManager.getInstance(SocietyWIseVoterDetIConnectQC.this).designation();
    ...
    private void setAdapter() {
        ...
        surveyroomlist.setLayoutManager(new LinearLayoutManager(SocietyWIseVoterDetIConnectQC.this));
        surveyroomlist.setAdapter(new RecyclerView.Adapter() {
                                      @NonNull
                                      @Override
                                      public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
                                          View view = LayoutInflater.from(SocietyWIseVoterDetIConnectQC.this).inflate(R.layout.adapter_room_listing, viewGroup, false);
    ...
    private void setInnerAdapter(OuterHolder myHolder, final List<VoterDetailedDataItem> voterDetailedData) {
        ...
        myHolder.innerrecyclerview.setLayoutManager(new LinearLayoutManager(SocietyWIseVoterDetIConnectQC.this));
        myHolder.innerrecyclerview.setAdapter(new RecyclerView.Adapter() {
                                                  @NonNull
                                                  @Override
                                                  public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
                                                      View view = LayoutInflater.from(SocietyWIseVoterDetIConnectQC.this).inflate(R.layout.adapter_survey_voter, viewGroup, false);
                                          ...
                                          SimpleDateFormat parseDate = new SimpleDateFormat("dd-MM-yyyy", Locale.US);*/
                                                      ...
                                                      innerHolder.callingbtn.setOnClickListener(new View.OnClickListener() {
                                                          ...
                                                          public void onClick(View v) {
                                                              ...
                                                              sendSMSWhatsApp.callMobNo(SocietyWIseVoterDetIConnectQC.this, model.getMobileNo());
                                                              ...
                                                              Toast.makeText(SocietyWIseVoterDetIConnectQC.this, "calling", Toast.LENGTH_SHORT).show();
                                                          }
                                                      });
                                                  ...
                                                  public void EditDialog(final String voterCd, String mobileNo, final int acNo, final String newBirthDate, final String tablename, final int voterid, final String voterfname, final String votermname, final String voterlname, final String remarktxt) {
                                                      ...
                                                      birthdate.setOnClickListener(new View.OnClickListener() {
                                                          ...
                                                          public void onClick(View v) {
                                                              try {
                                                                  ...
                                                                  fromDatePickerDialog = new DatePickerDialog(SocietyWIseVoterDetIConnectQC.this,
                                                      ...
                                                      update.setOnClickListener(new View.OnClickListener() {
                                                          @Override
                                                          public void onClick(View v) {
                                                              AlertDialog.Builder builder = new AlertDialog.Builder(SocietyWIseVoterDetIConnectQC.this);
    ...
    private void callApi() {
        mainlist.clear();
        final ProgressDialog progressBar = new ProgressDialog(SocietyWIseVoterDetIConnectQC.this);
        progressBar.setCancelable(false);
        progressBar.setProgressStyle(ProgressDialog.STYLE_SPINNER);
        progressBar.setMessage("Please wait...");
        progressBar.show();
        Call<MainResponse> call1 = RetrofitClient
                .getInstance().getApi().getRoomWiseDetailedListIConnectQC(sharedelectionname, intsite, intsubloccd, intcalling);
        call1.enqueue(new Callback<MainResponse>() {
            ...
            public void onResponse(Call<MainResponse> call1, Response<MainResponse> response) {
                ...
                if (res.getRoomWiseDetailedListPojo().size() > 0) {
                    ...
                    roomcount.setText("Total Room - " + mainlist.size());
                    Toast.makeText(SocietyWIseVoterDetIConnectQC.this, "No Records Exists For Selected Criteria!", Toast.LENGTH_LONG).show();
                    surveyroomlist.getAdapter().notifyDataSetChanged();
                }
            }
            ...
            public void onFailure(Call<MainResponse> call1, Throwable t) {
                progressBar.dismiss();
                Toast.makeText(SocietyWIseVoterDetIConnectQC.this, "Failed to fetch data !", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    public void updateBDAndMobNo(final Dialog dialog, final String birthdate, String selvotercd, final int ac_no, final String mobileno, String tablename, final String voterfname, final String votermname, final String voterlname, final String remark) {
        ...
        final ProgressDialog progressBar1 = new ProgressDialog(SocietyWIseVoterDetIConnectQC.this);
        progressBar1.setCancelable(false);
        progressBar1.setProgressStyle(ProgressDialog.STYLE_SPINNER);
        progressBar1.setMessage("Please wait...");
        progressBar1.show();
        Call<DefaultResponse> call1 = RetrofitClient
                .getInstance().getApi().updateBDAndMobileNo_uOtherQC(selvotercd, mobileno, sharedelectionname, intsite, ac_no, newBirthDate1, newBirthDate2, SharedPrefManager.getInstance(SocietyWIseVoterDetIConnectQC.this).username(), tablename, voterfname, votermname, voterlname, remark);
        call1.enqueue(new Callback<DefaultResponse>() {
            @Override
            public void onResponse(Call<DefaultResponse> call1, Response<DefaultResponse> response) {
                DefaultResponse res = response.body();
                ...
                newBirthDate2 = "";
                if (!res.isError()) {
                    AlertDialog.Builder builder1 = new AlertDialog.Builder(SocietyWIseVoterDetIConnectQC.this);
                    builder1.setCancelable(false);
                    builder1.setTitle("Alert ?");
                    builder1.setMessage(res.getErrormsg());
                    builder1.setNegativeButton("OK", new DialogInterface.OnClickListener() {
            ...
            public void onFailure(Call<DefaultResponse> call1, Throwable t) {
                progressBar1.dismiss();
                Toast.makeText(SocietyWIseVoterDetIConnectQC.this, "Failed to update !", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public void StartCallRecording(String filename) {
        if (checkFolder()) {
            ...
            callRecordSurvey = new CallRecord.Builder(SocietyWIseVoterDetIConnectQC.this)
    ...
    private class UploadFileToServer extends AsyncTask<String, Integer, String> {
        ...
        protected void onPreExecute() {
            ...
            progressBar.show();*/
            progressBar = new ProgressDialog(SocietyWIseVoterDetIConnectQC.this);
            progressBar.setCancelable(false);
            progressBar.setProgressStyle(ProgressDialog.STYLE_SPINNER);
                ...
                if (!jsonObject.getBoolean("error")) {
                    if(jsonObject.getString("errormsg").equalsIgnoreCase("All Records Update Successfully.")) {
                        if (deleteFileName != null && !deleteFileName.equalsIgnoreCase("")) {
                            ...
                            if (fdelete.exists()) {
                                if (fdelete.delete()) {
                                    Toast.makeText(SocietyWIseVoterDetIConnectQC.this, "file deleted", Toast.LENGTH_SHORT).show();
                                } else {
                                    Toast.makeText(SocietyWIseVoterDetIConnectQC.this, "file not deleted", Toast.LENGTH_SHORT).show();
                                }
                            } else {
                                Toast.makeText(SocietyWIseVoterDetIConnectQC.this, "file does not exists", Toast.LENGTH_SHORT).show();
                            }
                        } else {
                            Toast.makeText(SocietyWIseVoterDetIConnectQC.this, "file path is empty", Toast.LENGTH_SHORT).show();
                        }
                    }
                    AlertDialog.Builder builder1 = new AlertDialog.Builder(SocietyWIseVoterDetIConnectQC.this);
                    builder1.setCancelable(false);
