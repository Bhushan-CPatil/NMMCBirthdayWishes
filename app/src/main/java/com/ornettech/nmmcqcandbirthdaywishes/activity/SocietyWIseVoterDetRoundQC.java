...
import com.ornettech.nmmcqcandbirthdaywishes.model.MainResponse;
import com.ornettech.nmmcqcandbirthdaywishes.model.RoomWiseDetailedListPojoItem;
import com.ornettech.nmmcqcandbirthdaywishes.model.VoterDetailedDataItem;
...
import com.ornettech.nmmcqcandbirthdaywishes.utility.OuterHolder;
...
public class SocietyWIseVoterDetRoundQC extends AppCompatActivity {

    public TextView societyname, callingres, soccount, roomcount;
    public RecyclerView surveyroomlist;
    public String intsocname, intcalling, intsite, designation, roundno;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_society_w_ise_voter_det_round_q_c);

        roundno = getIntent().getStringExtra("roundno");
        if(roundno.equalsIgnoreCase("round1")){
            getSupportActionBar().setTitle(Html.fromHtml("<font color='#FFFFFF'>" + SharedPrefManager.getInstance(SocietyWIseVoterDetRoundQC.this).getElectionName() + " Round 1 </font>"));
        }else if(roundno.equalsIgnoreCase("round2")){
            getSupportActionBar().setTitle(Html.fromHtml("<font color='#FFFFFF'>" + SharedPrefManager.getInstance(SocietyWIseVoterDetRoundQC.this).getElectionName() + " Round 2 </font>"));
        }else if(roundno.equalsIgnoreCase("round3")){
            getSupportActionBar().setTitle(Html.fromHtml("<font color='#FFFFFF'>" + SharedPrefManager.getInstance(SocietyWIseVoterDetRoundQC.this).getElectionName() + " Round 3 </font>"));
        }
        ...
        sharedusername = SharedPrefManager.getInstance(SocietyWIseVoterDetRoundQC.this).username();
        sharedelectionname = SharedPrefManager.getInstance(SocietyWIseVoterDetRoundQC.this).getElectionName();
        designation = SharedPrefManager.getInstance(SocietyWIseVoterDetRoundQC.this).designation();
        ...
        intsite = getIntent().getStringExtra("ward");
        ...
        callingres.setText("QC Calling - " + intcalling + " (Ward No. - " + intsite + ")");
    ...
    private void callApi() {
        mainlist.clear();
        final ProgressDialog progressBar = new ProgressDialog(SocietyWIseVoterDetRoundQC.this);
        progressBar.setCancelable(false);
        progressBar.setProgressStyle(ProgressDialog.STYLE_SPINNER);
        progressBar.setMessage("Please wait...");
        progressBar.show();
        Call<MainResponse> call1 = RetrofitClient
                .getInstance().getApi().getRoomWiseDetailedListRoundsQC(sharedelectionname, intsite, intsubloccd, intcalling, roundno);
        call1.enqueue(new Callback<MainResponse>() {
            ...
            public void onResponse(Call<MainResponse> call1, Response<MainResponse> response) {
                ...
                if (res.getRoomWiseDetailedListPojo().size() > 0) {
                    ...
                    roomcount.setText("Total Room - " + mainlist.size());
                    Toast.makeText(SocietyWIseVoterDetRoundQC.this, "No Records Exists For Selected Criteria!", Toast.LENGTH_LONG).show();
                    surveyroomlist.getAdapter().notifyDataSetChanged();
                }
            }
            ...
            public void onFailure(Call<MainResponse> call1, Throwable t) {
                progressBar.dismiss();
                Toast.makeText(SocietyWIseVoterDetRoundQC.this, "Failed to fetch data !", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void setAdapter() {
        ...
        surveyroomlist.setLayoutManager(new LinearLayoutManager(SocietyWIseVoterDetRoundQC.this));
        surveyroomlist.setAdapter(new RecyclerView.Adapter() {
                                      @NonNull
                                      @Override
                                      public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
                                          View view = LayoutInflater.from(SocietyWIseVoterDetRoundQC.this).inflate(R.layout.adapter_room_listing, viewGroup, false);
    ...
    private void setInnerAdapter(OuterHolder myHolder, final List<VoterDetailedDataItem> voterDetailedData) {
        ...
        myHolder.innerrecyclerview.setLayoutManager(new LinearLayoutManager(SocietyWIseVoterDetRoundQC.this));
        myHolder.innerrecyclerview.setAdapter(new RecyclerView.Adapter() {
                                                  @NonNull
                                                  @Override
                                                  public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
                                                      View view = LayoutInflater.from(SocietyWIseVoterDetRoundQC.this).inflate(R.layout.adapter_survey_voter, viewGroup, false);
                                          ...
                                          SimpleDateFormat parseDate = new SimpleDateFormat("dd-MM-yyyy", Locale.US);*/
                                                      ...
                                                      innerHolder.edit.setOnClickListener(new View.OnClickListener() {
                                                          ...
                                                          public void onClick(View v) {
                                                              ...
                                                              //Toast.makeText(SocietyWIseVoterDetOtherQC.this, "edit"+model.getFullName(), Toast.LENGTH_SHORT).show();
                                                          }
                                                      });
                                                      ...
                                                      innerHolder.callingbtn.setOnClickListener(new View.OnClickListener() {
                                                          ...
                                                          public void onClick(View v) {
                                                              ...
                                                              sendSMSWhatsApp.callMobNo(SocietyWIseVoterDetRoundQC.this, model.getMobileNo());
                                                              /*Intent callIntent = new Intent(Intent.ACTION_DIAL);
                                                              callIntent.setData(Uri.parse("tel:9322554923"));
                                                              callIntent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                                                              if (ActivityCompat.checkSelfPermission(SocietyWIseVoterDetOtherQC.this, Manifest.permission.CALL_PHONE)
                                                                      != PackageManager.PERMISSION_GRANTED) {
                                                                  ActivityCompat.requestPermissions(SocietyWIseVoterDetOtherQC.this, new String[]{Manifest.permission.CALL_PHONE}, 1);
                                                              }
                                                              SocietyWIseVoterDetOtherQC.this.startActivity(callIntent);*/
                                                              Toast.makeText(SocietyWIseVoterDetRoundQC.this, "calling", Toast.LENGTH_SHORT).show();
                                                          }
                                                      });
                                                  ...
                                                  public void EditDialog(final String voterCd, String mobileNo, final int acNo, final String newBirthDate, final String tablename, final int voterid, final String voterfname, final String votermname, final String voterlname, final String remarktxt) {
                                                      final Dialog dialog = new Dialog(SocietyWIseVoterDetRoundQC.this);
                                                      ...
                                                      birthdate.setOnClickListener(new View.OnClickListener() {
                                                          ...
                                                          public void onClick(View v) {
                                                              try {
                                                                  ...
                                                                  fromDatePickerDialog = new DatePickerDialog(SocietyWIseVoterDetRoundQC.this,
                                                      ...
                                                      update.setOnClickListener(new View.OnClickListener() {
                                                          @Override
                                                          public void onClick(View v) {
                                                              AlertDialog.Builder builder = new AlertDialog.Builder(SocietyWIseVoterDetRoundQC.this);
                                    ...
                                    /*else if(m.isEmpty()){
                                        ...
                                        mname.requestFocus();
                                                  ...
                                                  public void UpdateStatusDialog(final String voterCd, String qcstatus, final int acNo, final String mobileNo) {
                                                      ...
                                                      ArrayAdapter<String> adapterx = new ArrayAdapter<String>(SocietyWIseVoterDetRoundQC.this, android.R.layout.simple_spinner_item, DBConnIP.arrayListToDialog);
    ...
    public void updateQCResponse(final Dialog dialog, final String selspinresponse, String selvotercd, final int ac_no, final String mobileno) {
        ...
        new UploadFileToServer().execute(selvotercd, mobileno, sharedelectionname, Integer.toString(ac_no),
                intsite, SharedPrefManager.getInstance(SocietyWIseVoterDetRoundQC.this).username(), selspinresponse, filePath);
        dialog.dismiss();
        ...
        Call<DefaultResponse> call1 = RetrofitClient
                .getInstance().getApi().updateCallingQC(selvotercd, mobileno, sharedelectionname, intsite, ac_no, SharedPrefManager.getInstance(SocietyWIseVoterDetOtherQC.this).username(), selspinresponse);
        call1.enqueue(new Callback<DefaultResponse>() {
            ...
            public void onResponse(Call<DefaultResponse> call1, Response<DefaultResponse> response) {
                ...
                if (!res.isError()) {
                    if (filename != null && !filename.equalsIgnoreCase("")) {
                        ...
                        if (fdelete.exists()) {
                            if (fdelete.delete()) {
                                Toast.makeText(SocietyWIseVoterDetOtherQC.this, "file deleted", Toast.LENGTH_SHORT).show();
                            } else {
                                Toast.makeText(SocietyWIseVoterDetOtherQC.this, "file not deleted", Toast.LENGTH_SHORT).show();
                            }
                        } else {
                            Toast.makeText(SocietyWIseVoterDetOtherQC.this, "file does not exists", Toast.LENGTH_SHORT).show();
                        }
                    } else {
                        Toast.makeText(SocietyWIseVoterDetOtherQC.this, "file path is empty", Toast.LENGTH_SHORT).show();
                    }
                    AlertDialog.Builder builder1 = new AlertDialog.Builder(SocietyWIseVoterDetOtherQC.this);
            ...
            public void onFailure(Call<DefaultResponse> call1, Throwable t) {
                progressBar1.dismiss();
                Toast.makeText(SocietyWIseVoterDetOtherQC.this, "Failed to update !", Toast.LENGTH_SHORT).show();
            }
        });*/
    ...
    public void updateBDAndMobNo(final Dialog dialog, final String birthdate, String selvotercd, final int ac_no, final String mobileno, String tablename, final String voterfname, final String votermname, final String voterlname, final String remark) {
        ...
        final ProgressDialog progressBar1 = new ProgressDialog(SocietyWIseVoterDetRoundQC.this);
        progressBar1.setCancelable(false);
        progressBar1.setProgressStyle(ProgressDialog.STYLE_SPINNER);
        progressBar1.setMessage("Please wait...");
        progressBar1.show();
        Call<DefaultResponse> call1 = RetrofitClient
                .getInstance().getApi().updateBDAndMobileNo_uOtherQC(selvotercd, mobileno, sharedelectionname, intsite, ac_no, newBirthDate1, newBirthDate2, SharedPrefManager.getInstance(SocietyWIseVoterDetRoundQC.this).username(), tablename, voterfname, votermname, voterlname, remark);
        call1.enqueue(new Callback<DefaultResponse>() {
            @Override
            public void onResponse(Call<DefaultResponse> call1, Response<DefaultResponse> response) {
                DefaultResponse res = response.body();
                ...
                newBirthDate2 = "";
                if (!res.isError()) {
                    AlertDialog.Builder builder1 = new AlertDialog.Builder(SocietyWIseVoterDetRoundQC.this);
                    builder1.setCancelable(false);
                    builder1.setTitle("Alert ?");
                    builder1.setMessage(res.getErrormsg());
                    builder1.setNegativeButton("OK", new DialogInterface.OnClickListener() {
            ...
            public void onFailure(Call<DefaultResponse> call1, Throwable t) {
                progressBar1.dismiss();
                Toast.makeText(SocietyWIseVoterDetRoundQC.this, "Failed to update !", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    public void StartCallRecording(String filename) {
        if (checkFolder()) {
            ...
            callRecordSurvey = new CallRecord.Builder(SocietyWIseVoterDetRoundQC.this)
                ...
                if (!jsonObject.getBoolean("error")) {
                    if(jsonObject.getString("errormsg").equalsIgnoreCase("All Records Update Successfully.")) {
                        if (deleteFileName != null && !deleteFileName.equalsIgnoreCase("")) {
                            ...
                            if (fdelete.exists()) {
                                if (fdelete.delete()) {
                                    Toast.makeText(SocietyWIseVoterDetRoundQC.this, "file deleted", Toast.LENGTH_SHORT).show();
                                } else {
                                    Toast.makeText(SocietyWIseVoterDetRoundQC.this, "file not deleted", Toast.LENGTH_SHORT).show();
                                }
                            } else {
                                Toast.makeText(SocietyWIseVoterDetRoundQC.this, "file does not exists", Toast.LENGTH_SHORT).show();
                            }
                        } else {
                            Toast.makeText(SocietyWIseVoterDetRoundQC.this, "file path is empty", Toast.LENGTH_SHORT).show();
                        }
                    }
                    AlertDialog.Builder builder1 = new AlertDialog.Builder(SocietyWIseVoterDetRoundQC.this);
                    builder1.setCancelable(false);
