...
public class SocietyListOfQC extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_society_list_of_qc);
        getSupportActionBar().setTitle(Html.fromHtml("<font color='#FFFFFF'>"+SharedPrefManager.getInstance(SocietyListOfQC.this).getElectionName()+" QC</font>"));
        ...
        sharedelectionname = SharedPrefManager.getInstance(SocietyListOfQC.this).getElectionName();
        ...
        from.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                fromDatePickerDialog = new DatePickerDialog(SocietyListOfQC.this,
        ...
        to.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                int mMonth = c.get(Calendar.MONTH); // current month
                int mDay = c.get(Calendar.DAY_OF_MONTH); // current day
                toDatePickerDialog = new DatePickerDialog(SocietyListOfQC.this,
                        new DatePickerDialog.OnDateSetListener() {
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (new CheckConnection(SocietyListOfQC.this).isNetworkConnected()) {
                    submitMethod(SocietyListOfQC.this);
                }else {
                    Toast.makeText(SocietyListOfQC.this,
    ...
    private void getSiteAndResponse() {
        ...
        responselist.clear();
        arrayList1.clear();
        final ProgressDialog progressBar = new ProgressDialog(SocietyListOfQC.this);
        ...
        call1.enqueue(new Callback<SiteAndQCResponse>() {
            ...
            public void onResponse(Call<SiteAndQCResponse> call1, Response<SiteAndQCResponse> response) {
                ...
                if(res.getSiteNameListPojo().size()>0) {
                    ...
                    ArrayAdapter<String> adapter = new ArrayAdapter<String>(SocietyListOfQC.this, android.R.layout.simple_spinner_item, arrayList);
                    adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
                    spinsitename.setAdapter(adapter);
                }else{
                    Toast.makeText(SocietyListOfQC.this, "No Site Exists !", Toast.LENGTH_LONG).show();
                }
                ...
                if(res.getResponseListPojo().size()>0) {
                    ...
                    ArrayAdapter<String> adapter1 = new ArrayAdapter<String>(SocietyListOfQC.this, android.R.layout.simple_spinner_item, arrayList1);
            ...
            public void onFailure(Call<SiteAndQCResponse> call1, Throwable t) {
                progressBar.dismiss();
                Toast.makeText(SocietyListOfQC.this, "Failed to fetch data !", Toast.LENGTH_LONG).show();
            }
        });
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        String designation = SharedPrefManager.getInstance(SocietyListOfQC.this).designation();
        ...
        report.setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem item) {
                startActivity(new Intent(SocietyListOfQC.this,QC_Calling_Report.class));
                return false;
            }
        });
        ...
        report2.setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() {
            @Override
            public boolean onMenuItemClick(MenuItem item) {
                startActivity(new Intent(SocietyListOfQC.this,QCResponseWiseReportActivity.class));
                return false;
            }
        });
        ...
        logout.setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() {
            @Override
            public boolean onMenuItemClick(MenuItem item) {
                SharedPrefManager.getInstance(SocietyListOfQC.this).clear();
                Intent intent = new Intent(SocietyListOfQC.this, LoginAcivity.class);
    ...
    private void callApi(final String newEdtFrom, final String newEdtTo, final Context context, final String sitename, final String msgres) {
        ...
        Call<SocRoomWiseResponse> call1 = RetrofitClient
                .getInstance().getApi().getSocietyListOfQC(newEdtFrom, newEdtTo, sharedelectionname, sitename, msgres);
        call1.enqueue(new Callback<SocRoomWiseResponse>() {
            ...
            public void onResponse(Call<SocRoomWiseResponse> call1, Response<SocRoomWiseResponse> response) {
                ...
                if(res.getSocietyRoomWiseQCListPojo().size()>0) {
                    ...
                    mAdapter = new Adapter_Soc_Room_Wise_List(context, newlist, "QC", sitename,newEdtFrom,newEdtTo,msgres);
