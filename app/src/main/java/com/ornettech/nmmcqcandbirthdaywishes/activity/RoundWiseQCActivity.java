...
public class RoundWiseQCActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sharedelectionname = SharedPrefManager.getInstance(RoundWiseQCActivity.this).getElectionName();

        submit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (new CheckConnection(RoundWiseQCActivity.this).isNetworkConnected()) {
                    submitMethod(RoundWiseQCActivity.this);
                } else {
                    Toast.makeText(RoundWiseQCActivity.this,
    ...
    private void getSiteAndResponse() {
        ...
        responselist.clear();
        arrayList1.clear();
        final ProgressDialog progressBar = new ProgressDialog(RoundWiseQCActivity.this);
        ...
        call1.enqueue(new Callback<SiteAndQCResponse>() {
            ...
            public void onResponse(Call<SiteAndQCResponse> call1, Response<SiteAndQCResponse> response) {
                ...
                if (res.getSiteNameListPojo().size() > 0) {
                    ...
                    ArrayAdapter<String> adapter = new ArrayAdapter<String>(RoundWiseQCActivity.this, android.R.layout.simple_spinner_item, arrayList);
                    adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
                    spinsitename.setAdapter(adapter);
                } else {
                    Toast.makeText(RoundWiseQCActivity.this, "No Site Exists !", Toast.LENGTH_LONG).show();
                }
                ...
                if (res.getResponseListPojo().size() > 0) {
                    ...
                    ArrayAdapter<String> adapter1 = new ArrayAdapter<String>(RoundWiseQCActivity.this, android.R.layout.simple_spinner_item, arrayList1);
            ...
            public void onFailure(Call<SiteAndQCResponse> call1, Throwable t) {
                progressBar.dismiss();
                Toast.makeText(RoundWiseQCActivity.this, "Failed to fetch data !", Toast.LENGTH_LONG).show();
            }
        });
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        String designation = SharedPrefManager.getInstance(RoundWiseQCActivity.this).designation();
        ...
        report.setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem item) {
                startActivity(new Intent(RoundWiseQCActivity.this, QC_Calling_Report.class));
                return false;
            }
        });
        ...
        report2.setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() {
            @Override
            public boolean onMenuItemClick(MenuItem item) {
                startActivity(new Intent(RoundWiseQCActivity.this, QCResponseWiseReportActivity.class));
                return false;
            }
        });
        ...
        logout.setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() {
            @Override
            public boolean onMenuItemClick(MenuItem item) {
                SharedPrefManager.getInstance(RoundWiseQCActivity.this).clear();
                Intent intent = new Intent(RoundWiseQCActivity.this, LoginAcivity.class);
    ...
    private void submitMethod(final Context context) {
        if (arrayList.size() > 0 && responselist.size() > 0) {
            ...
            callApi(context, spinsitename.getSelectedItem().toString().trim(), spinmsgres.getSelectedItem().toString().trim(), roundno);
    ...
    private void callApi(final Context context, final String sitename, final String msgres, final String round) {
        ...
        Call<SocRoomWiseResponse> call1 = RetrofitClient
                .getInstance().getApi().getSocietyListOfRoundsQC(sharedelectionname, sitename, msgres, round);
        call1.enqueue(new Callback<SocRoomWiseResponse>() {
            ...
            public void onResponse(Call<SocRoomWiseResponse> call1, Response<SocRoomWiseResponse> response) {
                ...
                if (res.getSocietyRoomWiseQCListPojo().size() > 0) {
                    ...
                    mAdapter = new Adapter_Soc_Room_Wise_List(context, newlist, round, sitename, "", "", msgres);
